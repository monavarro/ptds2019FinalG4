                      ...
                      tabItems(
                          ...
                          tabItem(tabName = 'menu_1',
                                  fluidPage(
                                      ...
                                      br(),
                                      br(),
                                      tags$iframe(width="800", height="450", src="https://www.youtube.com/watch?v=1wb7meCy_7U", frameborder="0", allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture", allowfullscreen=NA),
                                      br(),
                                      br(),
                                      br()
                                  )),
